...
<script>
	$(document).ready(function() {
		$("#write").on('click', function(event) {
			...
			document.form1.action = "${path}/myapp/qnainsert.do"
	...
	<div class='container-fluid'>
		...
		<section class="row section">
			...
			<br> <br> <br> 작성일 : <input id="date"
				...
				placeholder="글제목을 입력하세요"> 내용:
			<textarea id="contents" name="board_contents" class="form-control"
				rows="10"></textarea>
