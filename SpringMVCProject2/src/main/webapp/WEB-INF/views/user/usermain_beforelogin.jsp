...
<body>
    <div class='container-fluid'>
        ...
        <section class="row section">
            ...
            <p class="sec5">코로나 19 전후 1인가구 온라인 가공식품 소비패턴을 파악합니다.<br>코로나 19 이후 1인가구의 가공식품 소비 지출액이 증가한 품목<br>(육류가공품, 조미수산 가공품, 유가공품, 간편식, 면류, 빵, 떡, 전분/분말류, 다류)의 검색결과를<br> 크롤링하여 워드클라우드 분석을 했습니다.<br></p>
            <br>
            <br>
            <br>
            ...
            <p class="sec5">25가지 가공식품 세부항목 중 코로나 이후 지출액 증가비율의 평균 이상인 항목(1인가구, 소득범위별) :<br> 총 9개품목 (육류가공품, 조미수산가공품, 유가공품, 빵, 떡, 간편식, 면류, 전분/분말류, 다류 등)</p>
        </div>
        </section>
        <br><br>
