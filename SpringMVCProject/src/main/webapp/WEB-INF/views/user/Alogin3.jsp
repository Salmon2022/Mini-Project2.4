...
<body>
    <div class='container-fluid'>
        <header class='row header'>
            <div class="logo image-container"><a href='usermain_beforelogin'><img src='${pageContext.request.contextPath}/img/logo_transparent.png'
        ...
        <section class="row section">
            <div class="mainCon">
                ...
                <table class='loginTable'>
                    ...
                    <tr>
                        <td>비밀번호 : </td>
                        <td><input id="userPw" type="password" name="user_password" required></td>
                    </tr>
                    <tr>
                        <table
                            style='margin:auto; text-align:center; padding:20px; margin-top: 20px; margin-bottom: 20px; margin-left:44%'>
                            <td>
                            <button type="button" id="btnLogin">&nbsp;&nbsp;&nbsp;로그인&nbsp;&nbsp;&nbsp;</button>
                        	<button type="button" id="btnSign"><a href='Asign_up6'>&nbsp;&nbsp;&nbsp;회원가입&nbsp;&nbsp;&nbsp;</a></button><br>
                        	<button type="button" id="btnIdf"><a href='Afinding_id5'>아이디 찾기</button>
                        	<button type="button" id="btnPwf"><a href='Afinding_pw3'>비밀번호 찾기</a></button>
