...
<body>
    <div class='container-fluid'>
        <header class='row header'>
            <div class="logo image-container"><a href='usermain_beforelogin.html'><img src='img/logo_transparent.png'
        ...
        <section class="row section">
            ...
            <div class="left">
                <div class='btn-group-vertical' role='group' aria-label='...'>
                    <button type='button' class='btn btn-default'><a class='colortwo'
                            href='noticeboard.html'>공지사항</a></button>
                    <button type='button' class='btn btn-default'><a class='colortwo' href='q&aboard.html'>1:1
                            문의</a></button>
                </div>
            </div>
            ...
            <div class="right">
                ...
                <a class="btn btn-default pull-right btn1 color" href='#'>삭제</a>
                <a class="btn btn-default pull-right btn2 color" href='#'>등록</a>
            </div>
            </c:forEach>
        </section>
